...
const STATUS_OPTIONS = [
  { value: 'Còn hàng', label: 'Còn hàng', color: 'success' },
  { value: 'Sắp hết', label: 'Sắp hết', color: 'warning' },
  { value: 'Hết hàng', label: 'Hết hàng', color: 'error' },
]
...
const RECEIVERS = [
  { value: 'Đặng Thị Huyền - 190', label: 'Đặng Thị Huyền - 190' },
  { value: 'HTK Ly - 180', label: 'HTK Ly - 180' },
  { value: 'Nguyễn Văn A - 170', label: 'Nguyễn Văn A - 170' }
]
...
export default function CreateImportForm() {
  ...
  const handleAddPart = () => {
    ...
    const newPart = {
      ...
      status: values.partStatus || 'Còn hàng'
    }
  ...
  return (
    <WarehouseLayout>
      <Card
        title={<span style={{ fontSize: '20px', fontWeight: 600 }}>Tạo phiếu nhập kho</span>}
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={8}>
              ...
              >
                <DatePicker style={{ width: '100%' }} format="DD/MM/YYYY" placeholder="Chọn ngày nhập" />
              </Form.Item>
            </Col>
          </Row>
